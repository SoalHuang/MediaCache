...
//  MediaCache
//
//  Created by SoalHuang on 2019/2/25.
//  Copyright © 2019 soso. All rights reserved.
//

import Foundation

extension Array where Element == MediaRange {
    
    func split(limit: MediaRange.Bound) -> [Element] {
    ...
    func union(_ other: Element) -> [Element] {
        ...
        if overlapOffsets.count == 0 {
            ...
            let combine = MediaRange(lowerBound, upperBound)
